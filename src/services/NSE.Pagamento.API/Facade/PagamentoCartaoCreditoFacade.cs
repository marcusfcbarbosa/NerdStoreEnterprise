...
namespace NSE.Pagamento.API.Facade
{
    public class PagamentoCartaoCreditoFacade : IPagamentoFacade
    {
        ...
        {
            //isso daqui representa algo que se vc quiser salvar
            //em base de dados ou algo parecido
            return new Transacao
            {
                ...
                NSU = transaction.Nsu, //esse daqui foi o meio de pagamento que vc usou tipo paypal,pagseguro etc
                TID = transaction.Tid //esse daqui é o ID da transacao
            };
        }
