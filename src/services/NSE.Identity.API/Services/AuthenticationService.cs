...
namespace NSE.Identity.API.Services
{
    public class AuthenticationService
    {
        ...
        {
            //quando fizer o login, ele recebe o refreshToken junto
        ...
        private async Task<RefreshToken> GerarRefreshToken(string email)
        {
            ...
            //|Para apagar os historicos de token
        ...
        //validar se token bate com o valor
        public async Task<RefreshToken> ObterRefreshToken(Guid refreshToken)
        {
            var token = await _context.RefreshTokens.AsNoTracking()
                .FirstOrDefaultAsync(u => u.Token == refreshToken);
            //retorna o token conforme a sua validade em formato local , com meu horario local
